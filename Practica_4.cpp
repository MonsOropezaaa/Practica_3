...
•
29 feb
Hay dos archivos main, el archivo fuera del comprimido que se llama sinjerarquia es el archivo que utilizaré al inicio de la sesión, el archivo dentro del comprimido llamado conjerarquia es el que podrán usar para su ejercicio de clase si por alguna razón se atrasan con la explicación de código durante la clase.

Arbol jerarquico Sencillo.png
Imagen
...
Manual Práctica 4 Modelado Jerárquico JRRG.pdf
PDF

practica4 Modelado Jerarquico.zip
Archivo comprimido

practica4_sinjerarquía.cpp
Texto
